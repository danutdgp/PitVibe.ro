...
export default async function RegisterPage({ searchParams }: { searchParams: Promise<{ eroare?: string }> }) {
  ...
  return <AuthShell title="Intră în comunitate" subtitle="Contul este gratuit. După confirmarea e-mailului îți vei configura profilul." footer={<>Ai deja cont? <Link className="font-semibold text-violet-300" href="/autentificare">Autentifică-te</Link></>}>
